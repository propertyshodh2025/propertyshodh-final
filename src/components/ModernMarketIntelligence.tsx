...
import { TrendingUp, TrendingDown, BarChart3, PieChart, Activity, ArrowRight, Brain, Database, Search, Eye, Calculator } from 'lucide-react';
import { useLanguage } from '@/contexts/LanguageContext';
import { supabase } from '@/integrations/supabase/client';
import { ResearchReportDialog } from './ResearchReportDialog';
import ReadyReckonerRate from './ReadyReckonerRate';
    ...
    <section className="py-24 bg-gradient-to-b from-background via-muted/10 to-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full mb-16">
          ...
          <TabsContent value="ready-reckoner">
            <ReadyReckonerRate />
          </TabsContent>
        </Tabs>
      </div>

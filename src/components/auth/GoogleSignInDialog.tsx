      ...
      <DialogContent className="w-[90vw] max-w-md rounded-lg sm:rounded-lg mx-auto">
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="flex items-center justify-center gap-2 text-sm text-muted-foreground mt-4">
            ...
            <span>You'll need to accept our Terms & Disclaimer and verify your mobile number</span>
          </div>

          <p className="text-xs text-center text-muted-foreground">
            By continuing, you agree to complete the mandatory Terms of Service & Disclaimer and Privacy Policy acceptance process
          </p>
        </div>
      </DialogContent>
    </Dialog>

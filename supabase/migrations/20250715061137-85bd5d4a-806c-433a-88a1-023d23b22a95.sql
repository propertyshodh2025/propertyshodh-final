-- Update the app_role enum to include superadmin
...
CREATE TABLE public.admin_credentials (
  ...
  CONSTRAINT valid_admin_roles CHECK (role IN ('admin', 'superadmin'))
);
...
-- Insert initial superadmin credential (you can change this)
INSERT INTO public.admin_credentials (username, password_hash, role)
